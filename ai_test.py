...
#One Test for Llama3 and one for Mistral
def evaluate_models(message):
    ...
    return testModel1.choices[0].message.content, testModel2.choices[0].message.content 
...
class TestStringMethods(unittest.TestCase):
    def test_returns(self):
        ...
        tMod1, tMod2=evaluate_models(testMessage)
...
# Unit Test 3: Code Generation from each model
    ...
    # no backticks must be specified, otherwise code will be sent over in a markdown format that cannot be easily ran
        ...
        print(f"\n{tMod1}\n")
        print(f"\n{tMod2}\n")
        self.assertIn("sumThree", tMod1)
        self.assertIn("sumThree", tMod2)
...
# Unit Test 4: Running Unit Tests Produced by the Models
