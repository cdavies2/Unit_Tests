...
class TestStringMethods(unittest.TestCase):
    ...
    def test_fill(self):
        ...
        self.assertIn(y-x, list1) #check that x, y, and 7 (a between value) are in the generated list
        self.assertNotIn(11, list1) #check that a number out of range is not in the list


    def test_pets(self):
        pup=Pet("Sunny", "Dog")
        self.assertIsInstance(pup, Pet) #make sure an object was created properly from the class
        with self.assertRaises(TypeError):
